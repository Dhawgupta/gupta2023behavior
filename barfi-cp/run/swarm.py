...
parser.add_argument("--mins", "-s", type = int, default = 30) # not implemented yet
parser.add_argument("--cpus", '-c', type = int, default = 16)
parser.add_argument("--memory", '-m', type = int, default = 8)
parser.add_argument('--ntasks', '-n', type=int, default = 100) # number of tasks per CPU
