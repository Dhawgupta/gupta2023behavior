...
# axs.set_ylim([-10,120])
axs.set_ylabel('Aux Return', fontsize = 15)
axs.set_xlabel('Episodes', fontsize= 15)
axs.set_title("Aux Return / $\gamma$", fontsize = 20)
# axs.set_label
...
fig.savefig(f'{foldername}/auxcurve_{get_experiment_name}.pdf', dpi = 300)
fig.savefig(f'{foldername}/auxcurve_{get_experiment_name}.png', dpi = 300)
