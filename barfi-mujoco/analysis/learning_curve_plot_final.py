...
def get_label(label):
    if label == 'Frodo':
        label = 'Barfi Unrolled'
    elif label == 'Barfi':
        label = 'Barfi First Order'
    elif label == 'BarfiNeumann':
        label = 'Barfi'
    elif label == 'ActorCritic':
        label = 'Actor Critic'
    elif label == 'REINFORCEPotential':
        label = 'REINFORCE Potential'
    elif label == 'ActorCriticPotential':
        label = 'Actor Critic Potential'
...
figLegend1 = plt.figure(figsize=(10, 0.5))
