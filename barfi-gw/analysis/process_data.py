...
def process_runs(runs):
    ...
    quantiles = np.percentile(runs, [25, 50, 75], axis=0)
    ...
    for js in json_handles:
        ...
        for i in iterables:
            ...
            if os.path.exists(filename):
                ...
                mean_return, stderr_return, quantiles_return = process_runs(returns)
                # train
                returns_data = {
                    'mean' : mean_return,
                    'stderr' : stderr_return,
                    'quantiles' : quantiles_return
                }
                # gamma
